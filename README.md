...
- [sourcify-mcp](/services/mcp) - a standalone [Model Context Protocol](https://modelcontextprotocol.io) server that exposes verified-contract data (ABI, metadata, sources, verification status) to AI coding agents via the public Sourcify API.
- Packages:
