/**
 * Chain IDs that were previously supported but are now deprecated.
 * These are kept for reference and potential future use.
 */
export const DEPRECATED_CHAIN_IDS: Record<number, string> = {
  ...
  57000: "Rollux Testnet Tanenbaum",
